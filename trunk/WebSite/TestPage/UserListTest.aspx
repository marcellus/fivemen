<%@ Page Language="C#" AutoEventWireup="true" CodeFile="UserListTest.aspx.cs" Inherits="TestPage_UserListTest" %>
...
<body>
    <form id="Form1" runat="server">
        <table id="tb1" width="800" cellpadding="4" border="0" cellspacing="1" class="table-border"
            ...
            <tr class="table-content">
                <td align="right" colspan="2">
                    <asp:Button ID="Button1" runat="server" CssClass="button" OnClick="Button1_Click"
                        Text="添加" />用户名：<asp:TextBox ID="tbUserName" runat="server"></asp:TextBox><asp:Button ID="btnSearch"
            ...
            <tr class="table-content">
                <td colspan="2">
                    <asp:DataGrid ID="dg" runat="server" AutoGenerateColumns="False" OnDeleteCommand="dg_DeleteCommand"
                        ...
                        <Columns>
                            <asp:BoundColumn DataField="id" HeaderText="cuserid" Visible="False"></asp:BoundColumn>
                            <asp:BoundColumn DataField="c_name" HeaderText="用户名"></asp:BoundColumn>
                            <asp:BoundColumn DataField="c_password" HeaderText="密码" Visible="False"></asp:BoundColumn>
            ...
            <tr class="table-content">
                <td colspan="2">
                    &nbsp;<cc1:SimplePager ID="SimplePager1" runat="server" AllowBinded="True" BindControlString="dg">
                    </cc1:SimplePager>
                </td>
            </tr>
        </table>
