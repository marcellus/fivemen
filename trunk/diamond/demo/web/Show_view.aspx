<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage.master"  CodeFile="Show_view.aspx.cs" Inherits="Show_view"  Theme="DefaultTheme" %>
                            ...
                            <td align="left">
                                <b><font size="4" color="gray">
                                    <asp:Label ID="lbl_BuildingProfile" runat="server"
                                        Text="查看门店商品" Font-Size="Large"></asp:Label></font></b>
                            </td>
                        </tr>
        <tr>
            <td>
