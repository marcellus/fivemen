...
<div>请输入调拨单号 
    ...
    <asp:Button ID="btnSearch" OnClick="btnSearch_Click" CssClass="ButtonFlat" runat="server" Text="查询" />
    <asp:Button ID="btnFinishScanner" OnClick="btnFinish_Click" CssClass="ButtonFlat" runat="server" Text="完成出库扫描" />
     </div>
     <div>
