<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="StorageListMange.aspx.cs" Inherits="Storage_StorageListMange"  Theme="DefaultTheme"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <script language="javascript" type="text/javascript">
     ...
     function Open_AddWindow() {
         ...
         window.open('StorageDetails.aspx?type=new&rnd=' + Math.random(), '入库单', 'height=400px,width=330px,status=no,toolbar=no,menubar=no,top=' + iTop + ',left=' + iLeft + ',location=no,scrollbars=yes,resizable=no');
         return false;
 ...
 <table border="0" onkeydown="DoSearch()" width="100%">
 <tr><td>
     <table border="0"  width="100%">
         <tr>
             <td align="left">
                 <b><font color="gray" size="4">
                 <asp:Label ID="lbl_BuildingProfile" runat="server" Font-Size="Large" 
                     Text="入库单管理"></asp:Label>
                 </font></b>
             </td>
         </tr>
         ...
         <tr>
             ...
             <%--<input type="button" id="hiddenButton" runat="server" style="width: 83px" onclick="hiddenButton_Click"/>--%>
                 ...
                 <td>
                 <ace:ButtonEx ID="btn_Search" runat="server" CssClass="ButtonFlat" 
                             DialogHeight="400px" DialogWidth="600px" LeftSpace="0" 
                             OnClick="btn_Search_Click" RightSpace="0" ShowConfirmMsg="False" 
             ...
             <table border="0" cellpadding="1" cellspacing="0" width="100%">
                 <tr>
                     <td style="white-space: nowrap">
                         ...
                         &nbsp;&nbsp;&nbsp;&nbsp;
                         <ace:ButtonEx ID="btn_Add" runat="server" CssClass="ButtonFlat" 
                             DialogHeight="400px" DialogWidth="400px" LeftSpace="0" 
                             onClientClick="javascript:return Open_AddWindow();" RightSpace="0" 
                             ShowConfirmMsg="False" ShowWaitingPanel="False" Text="新增" Width="70px" />
                         &nbsp;&nbsp;&nbsp;&nbsp;
                         <ace:ButtonEx ID="btn_Delete" runat="server" CssClass="ButtonFlat" 
                             DialogHeight="400px" DialogWidth="400px" LeftSpace="0" 
                             onclick="btn_Delete_Click" onClientClick="javascript:return DeleteCheck();" 
                             RightSpace="0" ShowConfirmMsg="False" ShowWaitingPanel="False" Text="删除" 
                             Width="70px" />
                     </td>
                     <td align="left" style="width: 100%;display:none;">
                         <asp:Button ID="hiddenButton" runat="server"  />
                         <ace:ButtonEx ID="btn_Reset" runat="server" 
                             onClientClick="javascript:return ResetSearch();" Text="重置" Visible="False" 
                             Width="70px" />
                     </td>
                 </tr>
             </table>
     ...
     <tr>
         <td>
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                 <tr>
                     <td>
                         <ace:DataGridEx ID="dgProduct" runat="server" AllowExport="False" 
                             AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" 
                             CssClass="Grid" CurrentPageIndexEx="0" DownloadFileName="" HighLight="False" 
                             HighLightCssClass="DataGridHighLight" MAXRowCount="500" 
                             OnBuildDataSource="dgProduct_BuildDataSource" 
                             ...
                             <Columns>
                                 ...
                                 <ace:MultiQueryStringColumn CharCount="0" DataNavigateUrlField="StorageNo" 
                                     DataNavigateUrlFormatString="javascript:Open_Normal('StorageDetails.aspx?type=edit&amp;sid={0}','入库单');" 
                                     DataTextField="StorageNo" HeaderText="入库单号" NavigateUrl="" PopupWin="False" 
                                     Text="" WinHeight="700px" WinType="Normal" WinWidth="1050px">
