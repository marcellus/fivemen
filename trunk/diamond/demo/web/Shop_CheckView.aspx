<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Shop_CheckView.aspx.cs" MasterPageFile="~/MasterPage.master"  Inherits="Shop_CheckView"  Theme="DefaultTheme" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    function DeleteConfirm() {
        var re = window.confirm("Are you sure to delete these records ?");
        if (re) {
            return true;
        }
        else {
    ...
    <table width="100%" border="0" onkeydown="DoSearch()">
                            ...
                            <td align="left">
                                <b><font size="4" color="gray">
                                    <asp:Label ID="lbl_BuildingProfile" runat="server"
                                        Text="查看门店盘点结果" Font-Size="Large"></asp:Label></font></b>
                            </td>
                        </tr>
        <tr>
            <td>
        ...
        <tr>
            <td style="height: 23px; width:12%" align="right">
                <ace:LabelEx ID="LabelEx6" runat="server" CssClass="Label">门店:</ace:LabelEx>
            </td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="1">
                    <tr>
                        <td style="white-space: nowrap">
                            ...
                            &nbsp;&nbsp;
                            <ace:ButtonEx ID="btn_Export" Width="70px" Text="导出报告" runat="server" 
                            ...
                            <ace:DataGridEx ID="dgProduct" runat="server" AllowPaging="True" AllowSorting="True"
                                ...
                                <Columns>
                                    ...
                                    <ace:MultiQueryStringColumn WinType="Normal" DataTextField="Product_Name" HeaderText="品名"
                                        SortExpression="Product_Name" DataNavigateUrlField="Product_Name"
