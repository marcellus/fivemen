<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Finger_VerifyUser.aspx.cs" Inherits="Finger_VerifyUser" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        function AutoVerify() 
        {
            ...
            strTmp = VerifyForm.UCtrl.AuthenDlgExport("", strFin, 0);
            strTmp = UrlEncode(strTmp);
            window.location.href = "Identify.aspx?strTmp=" + strTmp
        }
