...
<div style=" width:1250px; height:820px;float:left" class="b">
  ...
  <div style=" height:70%">
    <iframe id="frameViewExamRecord" name="frameViewExamRecord" src="FpViewExamRecord.aspx" scrolling="no" frameborder="0" style="width:100%; height:100%; border-width:0px">
    </iframe>
  </div>
</div>
