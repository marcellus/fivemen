...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div>
       <asp:DataGrid ID="DataGrid1" runat="server" AutoGenerateColumns="false" BorderWidth="0px" CellPadding="1" CellSpacing="1" CssClass="table-border" Width="100%" >
         <Columns>
            <asp:BoundColumn DataField="c_depnickname" HeaderText="驾校" HeaderStyle-Width="120"></asp:BoundColumn>
             <asp:BoundColumn DataField="c_depcode" HeaderText="驾校代码" HeaderStyle-Width="100"></asp:BoundColumn>
            <asp:BoundColumn DataField="new_num" HeaderText="新导入" HeaderStyle-Width="60"></asp:BoundColumn>
            <asp:BoundColumn DataField="fee_num" HeaderText="已收费" HeaderStyle-Width="60"></asp:BoundColumn>
            <asp:BoundColumn DataField="lesson_finish_num" HeaderText="已上课" HeaderStyle-Width="60"></asp:BoundColumn>
         </Columns>
