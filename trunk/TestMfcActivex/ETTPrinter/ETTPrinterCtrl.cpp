// ETTPrintActiveXCtrl.cpp : CETTPrinterCtrl ActiveX 控件类的实现。
...
// CETTPrinterCtrl::CETTPrinterCtrl - 构造函数
...
// CETTPrinterCtrl::~CETTPrinterCtrl - 析构函数
...
// CETTPrinterCtrl::DoPropExchange - 持久性支持
...
// CETTPrinterCtrl::OnResetState - 将控件重置为默认状态
