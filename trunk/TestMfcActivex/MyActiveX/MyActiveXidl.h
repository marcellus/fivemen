...
EXTERN_C const IID DIID__DMyActiveX;
    ...
    MIDL_INTERFACE("8CE1671B-AA29-4130-854B-613A39A82298")
...
EXTERN_C const IID DIID__DMyActiveXEvents;
    ...
    MIDL_INTERFACE("ABCE71F8-C8D6-4B80-B24C-0073D63C1CAE")
...
class DECLSPEC_UUID("3978BB54-FC56-4784-9A6B-E880C8E71B41")
MyActiveX;
#endif
