...
class CETTA8IDCardActiveXCtrl : public COleControl
{
	DECLARE_DYNCREATE(CETTA8IDCardActiveXCtrl)
...
protected:
	...
	DECLARE_OLECREATE_EX(CETTA8IDCardActiveXCtrl)    // 类工厂和 guid
	DECLARE_OLETYPELIB(CETTA8IDCardActiveXCtrl)      // GetTypeInfo
	DECLARE_PROPPAGEIDS(CETTA8IDCardActiveXCtrl)     // 属性页 ID
	DECLARE_OLECTLTYPE(CETTA8IDCardActiveXCtrl)		// 类型名称和杂项状态
...
public:
	enum {
		dispidReadAndScan2Ex = 33L,
		dispidReadAndScanDpiEx = 32L,
		dispidGetCardStatusEx = 31L,
		dispidInitNationArray = 30L,
		dispidIdCard = 29,
		dispidImgPathPreX = 28,
		...
		dispidName = 13,
		dispidIsReaded = 12,
		dispidIdCardEndImgFileName = 11,
		dispidIdCardFrontImgFileName = 10,
		dispidIdCardImgFileName = 9,
		dispidReadAndScanEx = 8L,
		dispidDestroyDll = 7L,
		dispidEjectCardEx = 6L,
		dispidEnterCardEx = 5L,
		dispidCloseDeviceEx = 4L,
		dispidOpenDeviceEx = 3L,
		dispidLoadDll = 2L,
		dispidMessage = 1
	};
protected:
