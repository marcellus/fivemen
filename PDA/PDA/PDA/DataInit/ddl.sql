...
create table sendrecord(id integer primary key autoincrement,so varchar(20),otherso varchar(200),qufen varchar(20),pnno varchar(20),cpqufen varchar(20),sl integer,carno varchar(30),status integer);
