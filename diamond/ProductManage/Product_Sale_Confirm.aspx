<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/MasterPage.master" CodeFile="Product_Sale_Confirm.aspx.cs"  Theme="DefaultTheme"  Inherits="Product_Sale_Confirm" %>
...
<script language="JavaScript" type="text/javascript" src="Js/calendar.js"></script>
    ...
    <script type="text/javascript">
        ...
        function ConfirmOK() {
            var re = window.confirm("您确定当前产品销售无误？");
            if (re) {
                return true;
            }
            else {
                            ...
                            <td align="left">
                                <b><font size="4" color="gray">
                                    <asp:Label ID="lbl_BuildingProfile" runat="server"
                                        Text="产品销售确认" Font-Size="Large"></asp:Label></font></b>
                            </td>
                        </tr>
                        <tr>
                            <td class="NCLabelSmall" align="left">
                                &nbsp;<asp:Button ID="btn_Submit" runat="server" TabIndex="1" onclick="btn_OK_Click" Text="" Width="1px"/>
                                        ...
                                        &nbsp;
                                <ace:ButtonEx ID="btn_Submit0" runat="server" CssClass="ButtonFlat" 
                                    Text="确认" Width="100px"  RightSpace="2" 
                                    TabIndex="4" onclick="btn_Submit0_Click"/>
                            ...
                            <td>
                                ...
                                <tr>
                                        <td style="width:120px" align="left">
                                            <ace:LabelEx ID="LabelEx3" runat="server" CssClass="Label" Font-Size="Small">
                                                条码：</ace:LabelEx>
                                        </td>
                                        <td style="color: #FF0000" width="225">
                                            <ace:TextBoxEx ID="TextBoxEx1" runat="server" Width="200px"></ace:TextBoxEx>
                                            <ace:LabelEx ID="LabelEx8" runat="server" CssClass="Label" 
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #FF0000" width="225">
                                            <ace:TextBoxEx ID="txt_StyleID0" runat="server" Width="200px" MaxLength="100" 
