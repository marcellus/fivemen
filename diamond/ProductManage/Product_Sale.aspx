<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Product_Sale.aspx.cs"  Theme="DefaultTheme"  Inherits="Product_Sale" %>
                            ...
                            <td align="left">
                                <b><font size="4" color="gray">
                                    <asp:Label ID="lbl_BuildingProfile" runat="server"
                                        Text="产品销售" Font-Size="Large"></asp:Label></font></b>
                            </td>
                        </tr>
                        <tr>
                            <td class="NCLabelSmall" align="left">
                                &nbsp;<asp:Button ID="btn_Submit" runat="server" TabIndex="1" onclick="btn_OK_Click" Text="" Width="1px"/>
                                        ...
                                        &nbsp;<ace:ButtonEx ID="btn_Print" runat="server" CssClass="ButtonFlat" 
                                    Text="打印销售票据" Width="100px" RightSpace="2" 
                                    TabIndex="5" onclick="btn_Print_Click"/>
                                <ace:ButtonEx ID="btn_Submit0" runat="server" CssClass="ButtonFlat" 
                                    Text="确认销售" Width="100px"  RightSpace="2" 
                                    ...
                                    <tr>
                                        ...
                                        <td style="color: #FF0000" width="225">
                                            <ace:TextBoxEx ID="txt_StyleID0" runat="server" Width="200px" MaxLength="100" 
                                                onfocus="clearsortvalue();"></ace:TextBoxEx>
