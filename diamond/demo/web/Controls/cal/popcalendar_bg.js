...
//  email :	sai_freelance@yahoo.com
	...
	var gotoString = "轉到當前月份"
	var todayString = "今天是"
	var weekString = "周"
	var scrollLeftMessage = "選擇上個月份，按住滑鼠可以自動上翻."
	var scrollRightMessage = "選擇下個月份，按住滑鼠可以自動下翻."
	var selectMonthMessage = "選擇月份."
	var selectYearMessage = "選擇年."
	var selectDateMessage = "選擇 [date] ." // do not replace [date], it will be replaced by date.
    ...
    */
	...
	var monthName2 = new Array("1月","2月","3月","4月","5月","6月","7月","8月","9月","10月","11月","12月")
	if (startAt==0)
	{
	...
	dayName2 = new Array	("星期日","星期一","星期二","星期三","星期四","星期五","星期六")
	...
	function popUpCalendar(ctl,	ctl2, format, OtherFunctions) {
		...
		if (bPageLoaded)
		{
			if ( crossobj.visibility ==	"hidden" ) {
                ...
                if(ctl.offsetLeft+leftpos+256>document.body.clientWidth)
                {
                    leftpos -=  240 ;
                }
