...
function b_writeStyle() {
  ...
  var imgUrlBG = this.imgUrl + "/outlook_backgroupImage.gif";

  document.write('<STYLE TYPE="text/css">');

  document.write('.button {width:300;text-align:center;vertical-align:bottom; font-family:arial;');
  document.write(' font-size:8pt; cursor:hand; border-width:0;');
  document.write(' border-color:#ffffff; ');
  document.write('background-image:url("'+imgUrlBG+'")}');

  document.write('.noLine {text-decoration:none;text-valign:bottom}');

  document.write('.imgB {color:black; font-family:arial; font-size:8pt;}');
...
var c=0;
  ...
  var imgUrlBG = this.imgUrl + "/outlook_backgroupImage1.gif";
  var imgUrlArrowDown = this.imgUrl + "/outlook_arrowdown.gif";
  var imgUrlArrowUp = this.imgUrl + "/outlook_arrowup.gif";
  ...
  if (bt.ns4) {                 //draw OutlookBar for ns4
    ...
    for (i=0;i<this.panels.length;i++) {
      document.write('<Layer name='+this.name+'_panel'+i+' width='+this.width);
       ...
       document.write('width=16 height=16 src='+imgUrlArrowUp+' border=0>');
       ...
       document.write('src='+imgUrlArrowDown+' border=0></A></LAYER>');
    ...
    for (i=0;i<this.panels.length;i++) {
      ...
      if (!bt.op5) {
        ...
        document.write((this.width-c)+'; height:'+(23-c)+'"><img src="'+imgUrlBG+'" height="15"><A href="#" ');
        document.write('onClick="'+this.v+'.showPanel('+i+');this.blur();');
        document.write('return false;" ><FONT color=black ');
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src='+imgUrlArrowUp+' border=0>');
      ...
      document.write('onmouseOver="'+this.panels[i].v+'.clear();">');
      document.write('<img width=16 height=16 src='+imgUrlArrowDown+' border=0>');
      document.write('</A></DIV>');
...
function createOutlookBar(name,x,y,width,height,pagecolor,imgUrl) {
  this.imgUrl = imgUrl                    //Í¼Æ¬Î»ÖÃ Ðì½¨2003-7-20
  ...
  this.bgcolor="#B0D6FF";                   // bar background color
  this.pagecolor=pagecolor;               // page bgcolor (op5!)
  this.buttonspace=52                  // distance of panel buttons
