<%@ Page Language="C#" AutoEventWireup="true" CodeFile="SocialViewPaiBan.aspx.cs" Inherits="DriverPerson_Preasign_SocialViewPaiBan" %>
...
&nbsp;
        ...
        <br />
        (输入想预约的日期，并点击查看按钮，查看相应的排班，然后根据排班分配给非培训队<br />
