   ...
   var m_bolShowHour = true;//是否显示小时
   var m_bolShowMinute =true;//是否显示分钟
   ...
   function tiannetPopCalendar(){
    ...
    if (window.event.y + w > document.body.offsetHeight - 10   )
     iY = document.body.scrollTop + document.body.offsetHeight - w - 15 ;
    else
     iY = document.body.scrollTop +window.event.y + 15;  
    if (iY <0)  
     iY=0;
    dads.left = iX;
    dads.top = iY;
